...
export default function PrivacyPage() {
  return (
    <ViewTransition name="page-content" enter="page-enter" exit="page-enter">
      ...
      {/* Hero */}
      <section className="pt-36 pb-16 bg-[#070707] border-b border-[#1C1C1C]">
      ...
      <section className="section-py max-w-4xl mx-auto px-6 lg:px-8">
        <ScrollReveal>
          <p className="text-xs text-[#3a3a3a] mb-12 font-mono tracking-widest uppercase">
          ...
          {[
            ...
            <ScrollReveal key={s.title} delay={i * 50}>
              <div className="mb-10 pb-10 border-b border-[#1C1C1C] last:border-0">
                <h2
