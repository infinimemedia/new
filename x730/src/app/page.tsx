      ...
      <FlowArt aria-label="X730 Story">
        ...
        >
          ...
          <p className="max-w-[50ch] text-[clamp(1rem,2.5vw,1.75rem)] font-normal leading-relaxed opacity-80">
            ...
            individuals who cannot afford failure.
          </p>
          <hr className="border-t border-black/20" />
        ...
        >
          ...
          <div className="flex flex-wrap gap-[3vw]">
            {[
              ...
              { stat: "3 Continents", desc: "A global network of elite professionals ready to deploy anywhere." },
              { stat: "100%", desc: "Discretion — every client, every engagement, complete confidentiality." },
            ].map((s) => (
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-[#F4F4F5] text-[#070707] text-xs font-bold uppercase tracking-[0.15em] px-8 py-4 hover:bg-[#C4A35A] transition-colors duration-300"
            >
              Book a Consultation
              <ArrowRight size={14} />
            </Link>
            <Link
              href="/services"
              className="inline-flex items-center gap-2 border border-[#1C1C1C] text-[#5A5A5A] text-xs font-bold uppercase tracking-[0.15em] px-8 py-4 hover:border-[#C4A35A] hover:text-[#C4A35A] transition-colors duration-300"
            >
              Our Services
            </Link>
          </div>
